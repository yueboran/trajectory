    ...
    <div className="min-h-[100dvh] bg-[#141416] pb-24 animate-fade-in select-none font-sans w-full">
      ...
      {isFormOpen && (
        <div className="fixed inset-0 z-[100] flex items-end md:items-center justify-center">
          ...
          <div className="relative w-full max-w-md bg-[#1A1A1E] border border-[#2A2A2E] shadow-2xl rounded-t-2xl md:rounded-2xl p-6 animate-fade-in z-10 max-h-[85vh] md:max-h-[90vh] overflow-y-auto">
